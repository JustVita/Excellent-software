...
* **FOLX GO+**	  [下载工具](./Tools/download/FOLXGO.md) 
...
![](./screenshot/toolsScreenshot/charles.jpg)
...
![](./screenshot/toolsScreenshot/jumpDesktop.jpg)
...
* **1Password**	[密码](./Daily/passwordManager/password.md)
	* 随机生成高质量的密码
	* 支持快速搜索已保存账号信息
	* 可保存网站对应账号并直接转到填入
